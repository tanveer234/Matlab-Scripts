...
% Auto-generated by MATLAB on 22-Oct-2020 22:20:58
...
predictorNames = {'GR', 'HLLD', 'RHOB', 'DT', 'PHIN', 'NMRPorosity', 'BVI'};
predictors = inputTable(:, predictorNames);
response = inputTable.CoreK;
...
concatenatedPredictorsAndResponse.CoreK = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'BVI', 'DT', 'GR', 'HLLD', 'NMRPorosity', 'PHIN', 'RHOB'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.CoreK = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off');
